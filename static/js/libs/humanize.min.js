...
/**/
Humanize.intword=function(a){a=parseInt(a);if(a<1000000){return Humanize.intcomma(a,0)}else{if(a<100){return Humanize.intcomma(a,0)}else{if(a<1000){return Humanize.intcomma(a/100,1)+"00"}else{if(a<100000){return Humanize.intcomma(a/1000,1)+" тыс"}else{if(a<1000000){return Humanize.intcomma(a/100000,1)+"00 тыс"}else{if(a<1000000000){return Humanize.intcomma(a/1000000,1)+" млн"}else{if(a<1000000000000){return Humanize.intcomma(a/1000000000,1)+" млрд"}else{if(a<1000000000000000){return Humanize.intcomma(a/1000000000000,1)+" трлн"}}}}}}}}return a}
/*!
naturalDay
